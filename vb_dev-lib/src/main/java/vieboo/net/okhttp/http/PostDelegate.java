...
public class PostDelegate {
    ...
    private Request buildPostFormRequest(String url, Param[] params, Object tag) {
        ...
        {
            if(param.key.equals("accessToken")||param.key.equals("client-type")||param.key.equals("client-version")||param.key.equals("client-version-code")||param.key.equals("client-device-id")||param.key.equals("STL-AccessToken")){
                reqBuilder.addHeader(param.key, param.value);
            }else{
