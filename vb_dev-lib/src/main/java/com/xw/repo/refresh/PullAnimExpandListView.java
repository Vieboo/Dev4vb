 ...
 */
public class PullAnimExpandListView extends ExpandableListView implements Pullable {
    /*
    ...
    public PullAnimExpandListView(Context context) {
        super(context);
    }

    public PullAnimExpandListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PullAnimExpandListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public static abstract class AnimatedExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        private PullAnimExpandListView parent;

        private static final int STATE_IDLE = 0;
        private static final int STATE_EXPANDING = 1;
        private static final int STATE_COLLAPSING = 2;

        private void setParent(PullAnimExpandListView parent) {
            this.parent = parent;
        }
        ...
        public abstract void openAnim(int groupPositon);
        public abstract void closeAnim(int groupPositon);
