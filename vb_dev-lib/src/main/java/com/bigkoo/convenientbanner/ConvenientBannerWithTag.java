 ...
 * @author Sai 支持自动翻页
 */
public class ConvenientBannerWithTag<T> extends LinearLayout {
    ...
    public ConvenientBannerWithTag(Context context) {
        super(context);
        init(context);
    }

    public ConvenientBannerWithTag(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public ConvenientBannerWithTag(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public ConvenientBannerWithTag(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context) {
        View hView = LayoutInflater.from(context).inflate(
                R.layout.include_viewpager_tag, this, true);
        viewPager = (CBLoopViewPager) hView.findViewById(R.id.cbLoopViewPager);
        loPageTurningPoint = (ViewGroup) hView
                .findViewById(R.id.loPageTurningPoint);
        initViewPagerScroll();
        tv_tag = (TextView) hView.findViewById(R.id.tv_tag);
    ...
    static class AdSwitchTask implements Runnable {
        ...
        private final WeakReference<ConvenientBannerWithTag> reference;

        AdSwitchTask(ConvenientBannerWithTag convenientBanner) {
            this.reference = new WeakReference<ConvenientBannerWithTag>(convenientBanner);
        }

        @Override
        public void run() {
            ConvenientBannerWithTag convenientBanner = reference.get();
    ...
    public ConvenientBannerWithTag setPages(CBViewHolderCreator holderCreator, List<T> datas){
        this.mDatas = datas;
     ...
     * @param visible
     */
    public ConvenientBannerWithTag setPointViewVisible(boolean visible) {
     ...
     */
    public ConvenientBannerWithTag setPageIndicator(int[] page_indicatorId) {
     ...
     * @return
     */
    public ConvenientBannerWithTag setPageIndicatorAlign(PageIndicatorAlign align) {
     ...
     * @return
     */
    public ConvenientBannerWithTag startTurning(long autoTurningTime) {
        //如果是正在翻页的话先停掉
        if(turning){
            stopTurning();
        }
     ...
     * @return
     */
    public ConvenientBannerWithTag setPageTransformer(PageTransformer transformer) {
     ...
     * @return
     */
    public ConvenientBannerWithTag setOnPageChangeListener(ViewPager.OnPageChangeListener onPageChangeListener) {
     ...
     */
    public ConvenientBannerWithTag setOnItemClickListener(OnItemClickListener onItemClickListener) {
     ...
     * @param tag
     */
    public void setBannerTag(String tag) {
        if(null != tag) {
            tv_tag.setText(tag);
        }else {
            tv_tag.setText("");
